...
operation_t g_operations_map[MAX_OPERATION_TYPE] = {
    [RESET_STATE] = {RESET_STATE_NAME, RESET_STATE_PROMPT, run_reset_state},
    [INPUT_LIST] = {INPUT_LIST_NAME, INPUT_LIST_PROMPT, run_input_list},
    [PRINT_LIST] = {PRINT_LIST_NAME, PRINT_LIST_PROMPT, run_print_list},
    [EXIT_PROGRAM] = {EXIT_PROGRAM_NAME, EXIT_PROGRAM_PROMPT, run_exit_program},
    [BUILD_MIN_HEAP] = {BUILD_MIN_HEAP_NAME, BUILD_MIN_HEAP_PROMPT,
                        run_build_min_heap},
    [HEAP_SORT] = {HEAP_SORT_NAME, HEAP_SORT_PROMPT, run_heap_sort},
    [UNION_HEAPS] = {UNION_HEAPS_NAME, UNION_HEAPS_PROMPT, run_union_heaps},
    [INSERT_NODE] = {INSERT_NODE_NAME, INSERT_NODE_PROMPT, run_insert_node},
};
